        ...
        <form name="form1" enctype="multipart/form-data" method="post">
          <div class="row">
            ...
            <div class="form-group">
            	<img src="../product_images/{$product_image}" width="48" height="48"/>
            </div>
            <div class="form-group">
            	<label for="catimage">Product Image:</label>
            	<input type="file" class="form-control-file border" placeholder="Choose Image File" id="catimage" name="product_image" required>
           	</div>
